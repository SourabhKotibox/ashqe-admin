...
const wrapPreviewEmail = (body: string, platformName = 'Ashqe'): string => {
...
export default function NotificationTemplateFormPage() {
  ...
  const previewHtml =
    previewTarget === "email"
      ? wrapPreviewEmail(replacePreviewVariables(form.emailTemplate || "<p>No email template set.</p>", sampleVars), settings?.platformName || "Ashqe")
          ...
          <div className="rounded-xl border border-border bg-card/50 p-5 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input value={form.notifSubject} onChange={(e) => set("notifSubject", e.target.value)}
                placeholder={`e.g. Welcome to ${settings?.platformName || "Ashqe"}`} className={inputCls} />
            </div>
            <div className="space-y-2">
