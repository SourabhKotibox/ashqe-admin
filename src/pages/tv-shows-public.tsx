...
export default function TvShowsPublicPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0c14] font-sans text-white selection:bg-primary/30">
      <PublicHeader
        activeTab={activeTab}
        setActiveTab={(tab) => {
      ...
      <div className="pt-[68px]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-white font-black text-xl sm:text-2xl tracking-tight">Web Series</h1>
                  </div>
        ...
        {/* Filters Row */}
        <div className="sticky top-[68px] z-30 bg-[#0c0c14]/95 backdrop-blur-md border-b border-white/5 px-4 sm:px-8 lg:px-14 py-3">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="relative flex-shrink-0">
              <button
                ...
                className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-transparent border-white/20 text-white hover:border-white/50 text-sm font-medium transition-all"
              >
        ...
        <div className="px-4 sm:px-8 lg:px-14 py-8">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-5">
              {[...Array(12)].map((_, i) => (
                <div key={i} className="rounded-2xl bg-zinc-900/60 border border-white/5 aspect-[2/3] animate-pulse relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 h-4 bg-white/10 rounded-full w-2/3" />
                  <div className="absolute bottom-10 left-4 h-3 bg-white/5 rounded-full w-1/3" />
                </div>
              ))}
            </div>
          ) : (
